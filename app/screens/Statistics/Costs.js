            ...
            charts = <View>
                <View style={styles.card}>
                    ...
                    <Pie
                        ...
                        height={530}
                        data={this.props.statistics.data.result.status.price} />
                </View>
                <View style={styles.card}>
                    ...
                    <Pie
                        ...
                        width={window.width - 20}
                        height={530}
                        data={this.props.statistics.data.result.country.price} />
                </View>
                <View style={styles.card}>
                    ...
                    <Pie
                        ...
                        width={window.width - 20}
                        height={530}
                        data={this.props.statistics.data.result.operator.price} />
                ...
                <View style={styles.card}>
                    ...
                    <Pie
                        ...
                        width={window.width - 20}
                        height={530}
                        data={this.props.statistics.data.result.senderId.price} />
                </View>
                <View style={styles.card}>
                    ...
                    <Pie
                        ...
                        width={window.width - 20}
                        height={530}
                        data={this.props.statistics.data.result.service.price} />
                </View>
                <View style={styles.card}>
                    ...
                    <Pie
                        ...
                        width={window.width - 20}
                        height={530}
                        data={this.props.statistics.data.result.extensions.price} />
                </View>
                <View style={styles.card}>
                    ...
                    <Pie
                        ...
                        width={window.width - 20}
                        height={530}
                        data={this.props.statistics.data.result.route.price} />
                </View>
            </View>
        }
...
module.exports = connect(mapStateToProps)(Costs);
